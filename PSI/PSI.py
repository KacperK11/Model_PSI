...
# ============================================================
#  DODATEK: STROJENIE MODELI ODJĘTYCH (DLA PORÓWNANIA)
# ============================================================

print("\n" + "="*60)
print(" DODATKOWY EKSPERYMENT: STROJENIE ODJĘTYCH METOD")
print("="*60)

tuned_results = []

# --- 1. STROJENIE REGRESJI LOGISTYCZNEJ (LOGISTIC REGRESSION) ---
print("\n>>> 1. Optymalizacja Logistic Regression...")
...
# Siatka parametrów:
# C - odwrotność siły regularyzacji (mniejsze C = silniejsza regularyzacja)
param_grid_lr = {
...
print(f"Najlepsze parametry (LogReg): {gs_lr.best_params_}")
print(f"Najlepszy ROC AUC (train CV): {gs_lr.best_score_:.3f}")
...
# --- 2. STROJENIE MASZYNY WEKTORÓW NOŚNYCH (SVM) ---
print("\n>>> 2. Optymalizacja SVM (To może chwilę potrwać)...")
...
# Siatka parametrów SVM:
# C - margines błędu (duże C = dopasowuje się mocno, małe C = gładsza granica)
...
print(f"Najlepsze parametry (SVM): {gs_svm.best_params_}")
print(f"Najlepszy ROC AUC (train CV): {gs_svm.best_score_:.3f}")
...
# --- DODAJEMY NAJLEPSZY RANDOM FOREST DLA PEŁNEGO OBRAZU ---
...
# --- 3. TABELA PODSUMOWUJĄCA WSZYSTKIE ZOPTYMALIZOWANE MODELE ---
print("\n" + "="*60)
print(" PODSUMOWANIE KOŃCOWE - PO STROJENIU WSZYSTKICH MODELI")
print("="*60)
